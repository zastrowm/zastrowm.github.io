...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notifications = {
	  ...
	  notify: function(type, data) {var $__0, $__1, $__2;
	    var callback;for($__0=this.callbacks,$__1=Array.isArray($__0),$__2=0,$__0=$__1?$__0:$__0[/*global Symbol*/typeof Symbol=="function"?Symbol.iterator:"@@iterator"]();;) {if($__1){if($__2>=$__0.length) break;callback=$__0[$__2++];}else{$__2=$__0.next();if($__2.done) break;callback=$__2.value;}
	      callback(type, data);
	    }
	  }
	};
	  ...
	  function FormattedValue(likeMoney) {"use strict";
	    this.value = 0;
	    this.likeMoney = likeMoney;
	    this.isFocused = false;
	  }

	  Object.defineProperty(FormattedValue.prototype,"reset",{writable:true,configurable:true,value:function() {"use strict";
	    this.value = 0;
	  }});

	  Object.defineProperty(FormattedValue.prototype,"toString",{writable:true,configurable:true,value:function() {"use strict";
	  ...
	  Object.defineProperty(FormattedValue.prototype,"valueOf",{writable:true,configurable:true,value:function() {"use strict";
	    return this.value;
	  }});
	  ...
	  function PriceQuantity() {"use strict";
	    this.price = new FormattedValue(true);
	  ...
	  Object.defineProperty(PriceQuantity.prototype,"reset",{writable:true,configurable:true,value:function() {"use strict";
	    this.price.reset();
	    this.quantity.reset();
	  }});
	  ...
	  function App() {"use strict";
	    this.left = new PriceQuantity();
	    this.right = new PriceQuantity();

	    this.focused = this.left.price;
	    this.focused.isFocused = true;

	    this.left.quantity.focused = true;

	    this.all = [this.left.price, this.left.quantity, this.right.price, this.right.quantity];

	    Notifications.subscribe(this.onNotify.bind(this));
	  }

	  Object.defineProperty(App.prototype,"onNotify",{writable:true,configurable:true,value:function(type, data) {"use strict";
	    ...
	    switch (type) {
	      case "focused":
	        ...
	        break;
	      case "update":
	        this.focused.value = this.focused.value * 10 + data;
	        break;
	      case "clear":
	        this.focused.value = 0;
	        break;
	      case "reset":
	        Notifications.notify("focused", this.left.price);
	        this.left.reset();
	        this.right.reset();
	        break;
	      case "new":
	  ...
	  Object.defineProperty(App.prototype,"moveNext",{writable:true,configurable:true,value:function() {"use strict";
	    var index = this.all.indexOf(this.focused);
	    var next = this.all[(index + 1) % 4];
	  ...
	  Object.defineProperty(App.prototype,"movePrevious",{writable:true,configurable:true,value:function() {"use strict";
	    ...
	    var next = this.all[(index + 3) % 4];

	    Notifications.notify("focused", next);
	  }});


	var ____Class0=React.Component;for(var ____Class0____Key in ____Class0){if(____Class0.hasOwnProperty(____Class0____Key)){FormattedValueView[____Class0____Key]=____Class0[____Class0____Key];}}var ____SuperProtoOf____Class0=____Class0===null?null:____Class0.prototype;FormattedValueView.prototype=Object.create(____SuperProtoOf____Class0);FormattedValueView.prototype.constructor=FormattedValueView;FormattedValueView.__superConstructor__=____Class0;function FormattedValueView(){"use strict";if(____Class0!==null){____Class0.apply(this,arguments);}}

	  Object.defineProperty(FormattedValueView.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	    var viewModel = this.props.viewModel;

	    var classes = this.props.type + (viewModel.isFocused ? " focused" : "");

	    var tip = this.props.type == "price" ? "price" : "quantity";
	...
	var ____Class2=React.Component;for(var ____Class2____Key in ____Class2){if(____Class2.hasOwnProperty(____Class2____Key)){InputView[____Class2____Key]=____Class2[____Class2____Key];}}var ____SuperProtoOf____Class2=____Class2===null?null:____Class2.prototype;InputView.prototype=Object.create(____SuperProtoOf____Class2);InputView.prototype.constructor=InputView;InputView.__superConstructor__=____Class2;function InputView(){"use strict";if(____Class2!==null){____Class2.apply(this,arguments);}}

	  Object.defineProperty(InputView.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	    ...
	    for (var i = 0; i < 10; i++) {
	      ...
	      buttons.push(React.createElement("button", {onClick: function()  {return Notifications.notify("update", value);}}, value));
	    }
	...
	var ____Class3=React.Component;for(var ____Class3____Key in ____Class3){if(____Class3.hasOwnProperty(____Class3____Key)){AppView[____Class3____Key]=____Class3[____Class3____Key];}}var ____SuperProtoOf____Class3=____Class3===null?null:____Class3.prototype;AppView.prototype=Object.create(____SuperProtoOf____Class3);AppView.prototype.constructor=AppView;AppView.__superConstructor__=____Class3;

	  function AppView(props) {"use strict";
	    ____Class3.call(this,props);

	    this.state = {count: 0};

	    Notifications.subscribe(function(type, data)  {
	      this.setState({count: this.state.count + 1});
	    }.bind(this));
	  }

	  Object.defineProperty(AppView.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	    var app = this.props.viewModel;
	    var self = this;

	    return (
	      React.createElement("div", {className: "app"}, 
	        React.createElement("div", {className: "display"}, 
	          React.createElement(PriceQuantityView, {viewModel: app.left}), 
	          React.createElement(PriceQuantityView, {viewModel: app.right})
	        ), 
	        React.createElement(InputView, {className: "input", viewModel: app})
	      )
	    )
	  }});
	...
	window.addEventListener('load', function() {
	  var app = new App();
	  React.render(React.createElement(AppView, {viewModel: app}),document.body);
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./entry.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./entry.css");
